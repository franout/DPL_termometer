...
\fancypagestyle{plain}{
    % Headers
    \fancyhead[L]{Report Lab 1}
    \fancyhead[R]{\fontsize{10}{11}  \textsc{DE LABRIFFE} Axel - \textsc{Angione} Francesco }
    ...
    \fancyfoot[RE]{Lab 1 - DAT278}
    \fancyfoot[LO]{DAT278 - Lab 1}
}
...
\begin{center}
\includegraphics[height=3cm]{chalmers_logo.png}\\
\vspace{2.5cm}
\presentation{Chalmers University Of Technology} 
\presentation{?? - Digital Project laboratory }

\vspace{2cm}
\noindent\fbox{
\begin{minipage}{0.9\textwidth}
\begin{center}
    \presentationLarge{Report}
    \presentationLarge{\Huge{Lab 2}}
\end{center}
\end{minipage}}
\vspace{3cm}

\presentation{Autumn 2019}
\vspace{1cm}

\def\arraystretch{1.5} % 1 is the default
\begin{tabular}{|>{\hfill\arraybackslash}p{5cm}|p{5cm}|p{5cm}|p{5cm}|}
\hline
    \multicolumn{2}{|c|}{\textsc{ANGIONE} Francesco}\\
...
{\let\clearpage\relax { \chapter{Experimental setup and method} }}
