# 
# Project automation script for top_termometer 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source top_termometer.tcl), then you can
...
set myProject "top_termometer"
set myScript "top_termometer.tcl"
...
proc set_project_props {} {
   ...
   project set family "Artix7 Low Voltage"
   project set device "xc7a100tl"
   project set package "csg324"
   project set speed "-2L"
...
proc add_source_files {} {
   ...
   xfile add "tb_top_termometer.vhd"
   xfile add "top_termometer.vhd"

   # Set the Top Module as well...
   project set top "structural" "top_termometer"
